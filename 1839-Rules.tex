...
journey between \noun{Amsterdam} and \noun{Haarlem}. Then it was difficult.
...
Werktuigen}'s revenue (see \parref{Koninklijke-Nederlandsche-Fabriek}
...
\item One yellow, one green, one red and one gray train.
\item Private companies: 
\begin{itemize}
\item Blue: \noun{Crédit Mobilier}
\item Brown: \noun{August Borsig}.
...
en Reigers te Ulft }(see: \ref{par:Diepenbrock-en-Reigers})
...
\hline 
Light Yellow & 2 & 5 & \textflorin 80 &  & 3 & Yellow & 1 & \textflorin 25, \textflorin 38,\\
 \textflorin 55 & \textflorin 67, \textflorin 74\\
 \& \textflorin 82\tabularnewline
\hline 
Dark Yellow & 2+1 & 4 & \textflorin 120 &  & 3 & Yellow & 1 & \textflorin 25, \textflorin 38,\\
 \textflorin 55 & \textflorin 67, \textflorin 74\\
 \& \textflorin 82\tabularnewline
\hline 
Light Green & 3 & 5  & \textflorin 140 &  & 3 & Yellow\\
Green & 2 & \textflorin 25, \textflorin 38,\\
 \& \textflorin 55 & \textflorin 67, \textflorin 74\\
 \& \textflorin 82\tabularnewline
\hline 
...
Green\\
Brown & 2 & \textflorin 25, \textflorin 38,\\
...
Green\\
Brown & 3 & \textflorin 25, \textflorin 38,\\
 \& \textflorin 55 & \textflorin 67\tabularnewline
\hline 
...
Green\\
Brown\\
Gray & 3 & \textflorin 25, \textflorin 38,\\
 \& \textflorin 55 & \textflorin 67\tabularnewline
\hline 
...
\begin{itemize}
\item Player number cards are reassigned in order of ascending remaining
cash with ties retaining their relative order.
\item The Stock Round starts with the player with the \#1 player number
card.
\end{itemize}
\end{itemize}
...
order (see \subsecref{company-operating-order} \nameref{subsec:company-operating-order}
...
player, then the new director must choose whether to redeem the shares
just sold.
\end{itemize}
...
the IPO by:
\begin{enumerate}
\item Selecting a not-yet-parred Spoorwegmaatschappij or Lokaalspoorwegen
(see \tabref{Public-Companies} \nameref{tab:Public-Companies} \&
...
\item If the company treasury is insufficient to pay the fee, then the additional
necessary funds must be provided by the director of the company.
\item \emph{(If the director does not have enough money to contribute to
cover the fee)} The director must sell shares to raise the additional
funds (see \subsecref{Selling-shares} \nameref{subsec:Selling-shares}). 
\item Normal share-selling rules apply (see \subsecref{Selling-shares}
\nameref{subsec:Selling-shares}).
\item Director control of the \emph{Lokaalspoorwegen} may not be transferred
to another player while paying the fee (see \subsecref{Company-directors}
\nameref{subsec:Company-directors})
\item The director of the \emph{Lokaalspoorwegen} cannot contribute more
money than is required to pay the fee and cannot sell additional shares
once enough money has been raised.
\item If the \emph{Lokaalspoorwegen} is still unable to pay the fee for
its home stations after the director has contributed all possible
funds and sold all shares that can be legally sold (see \subsecref{Selling-shares}
\nameref{subsec:Selling-shares}), then the player is bankrupt (see
...
be legally sold (see \subsecref{Selling-shares} \nameref{subsec:Selling-shares}),
then the player is bankrupt (see \secref{Player-Bankruptcy} \nameref{sec:Player-Bankruptcy}).
...
from the top down.
\item Share companies that have operated in the current Operating Round
...
The Local Public Company buys the next available train (\emph{unless
...
or upgrade the yellow track tile it placed in the same Operating Round.
\begin{description}
\item [{Exception:}] A public company that owns the \noun{Het Laantje van
der Gaag} green private company (see \parref{Het-Laantje-van} \nameref{par:Het-Laantje-van})
may place an additional yellow track tile for a cost of \textflorin 20
paid to the bank in addition to any terrain or upgrade costs (the
terrain is free if the tile is placed on H7) from the company treasury,
closing the private.
\end{description}
...
\end{itemize}
\item Pay a fee to the bank equal to three times the revenue of the location
of the newly placed station marker.
\begin{itemize}
...
\end{description}
\item Pay a fee to the bank equal to three times the revenue of the location
the acting company's station marker moved to.
\begin{itemize}
...
\item Local Public Companies cannot pay half-dividends in blue phase or
later (see \secref{Game-Phases} \nameref{sec:Game-Phases}).
\end{itemize}
...
\paragraph{Train buys \label{par:Train-purchasing}}
\begin{itemize}
...
\nameref{subsec:Emergency-train-buying}).
\begin{description}
\item [{Exception:}] \emph{(Prior to blue phase)} A Local Public Company's
only train cannot be bought by another company.
\end{description}
\item A public company without a train, must buy a train from the supply.
...
\nameref{tab:Game-Phases} and \secref{Game-Phases} \nameref{sec:Game-Phases})
and apply immediately throughout the game.
\end{itemize}

\paragraph{Emergency train buys \label{subsec:Emergency-train-buying}}
\begin{itemize}
...
\begin{itemize}
\item By failing to pay for a \noun{Lokaalspoorwegen's} home stations when
it floats (see \subsecref{Starting-or-floating} \nameref{subsec:Starting-or-floating}
...
\nameref{subsec:Paying-red-private} \& \parref{Rotterdamsche-Bank}
...
the IPO before selling them to the Bank Pool. 
\begin{itemize}
...
\begin{figure*}
\includegraphics[width=6.75in,height=8.5in]{Map}
...
\begin{figure}
\includegraphics[angle=90,width=1\columnwidth]{Market}
...
the the Local Stock Market: \textflorin 25, \textflorin 38 or \textflorin 55.
\item Spoorwegmaatschappij can par at:
\begin{itemize}
\item \textflorin 82 in light yellow, dark yellow, light green or dark green
phase.
\item \textflorin 74 in light yellow, dark yellow, light green, dark green
or blue phase.
...
\nameref{par:Rotterdamsche-Bank}) and pays the bank at the start
of each Operating Round.
\end{description}
...
\end{itemize}
\item Brown and red private companies cannot be bought by public companies
...
Gaag} green private company has been bought by a public company or
closed (see \parref{Het-Laantje-van} \nameref{par:Het-Laantje-van}).
...
\begin{description}
\item [{Nickname:}] ``station teleport''
...
A station-moving company can include the moved station marker in its
new location as one of the company's station markers on a route in
that Operating Round (see \subsecref{General-Route-definition} \nameref{subsec:General-Route-definition}).
\begin{description}
...
company at any time. If a player owning the \noun{Diepenbrock en Reigers
te Ulft} bankupts or concedes (see \secref{Player-Bankruptcy}\nameref{sec:Player-Bankruptcy}),
then the matching dark brown train is discarded from the supply. Should
...
\subparagraph{\noun{Crédit Mobilier\label{par:Cr=0000E9dit-Mobilier}}}
\begin{description}
\item [{Nickname:}] ``Crédit''
\item [{Face~value:}] \textflorin 260
\item [{Revenue:}] \textflorin 0
\item [{Blocks:}] None
\item [{Closes:}] At the start of dark brown phase.
\item [{Power:}] When closed converts to \textflorin 740 in cash taken
...
company is discarded from the game and not used (see \secref{Game-Setup}
\nameref{sec:Game-Setup}).
\item The brown private companies are each randomly assigned 30\% of different
Spoorwegmaatschappij during setup (see \secref{Game-Setup} \nameref{sec:Game-Setup}
\& \subsecref{Public-companies} \nameref{subsec:Public-companies}).
...
\nameref{subsec:Paying-red-private}).
\end{description}
...
\hline 
\noun{Lokaalspoorwegen \#1} & L1 & Lokaalspoorwegen & (Director-selected) & Local & Yes & 3 & 2\tabularnewline
\hline 
\noun{Lokaalspoorwegen \#2} & L2 & Lokaalspoorwegen & (Director-selected) & Local & Yes & 3 & 2\tabularnewline
\hline 
\noun{Lokaalspoorwegen \#3} & L3 & Lokaalspoorwegen & (Director-selected) & Local & Yes & 3 & 2\tabularnewline
\hline 
\noun{Lokaalspoorwegen \#4} & L4 & Lokaalspoorwegen & (Director-selected) & Local & Yes & 3 & 2\tabularnewline
\hline 
\noun{Lokaalspoorwegen \#5} & L5 & Lokaalspoorwegen & (Director-selected) & Local & Yes & 3 & 2\tabularnewline
\hline 
\noun{Lokaalspoorwegen \#6} & L6 & Lokaalspoorwegen & (Director-selected) & Local & Yes & 3 & 2\tabularnewline
\hline 
\noun{Lokaalspoorwegen \#7} & L7 & Lokaalspoorwegen & (Director-selected) & Local & Yes & 3 & 2\tabularnewline
\hline 
\noun{Lokaalspoorwegen \#8} & L8 & Lokaalspoorwegen & (Director-selected) & Local & Yes & 3 & 2\tabularnewline
\hline 
\end{tabular}
...
again in subsequent Stock Rounds (see \subsecref{Starting-or-floating}
\nameref{subsec:Starting-or-floating}).
\end{itemize}
\end{itemize}
...
\nameref{sec:Trains-and-Running-Trains}).
\item Cannot have their only train bought by another company unless the
...
\nameref{tab:Public-Companies} \& \secref{Stock-Market} \nameref{sec:Stock-Market}).
\item Can (\emph{before blue phase}) withhold dividends or pay half-dividends
or (\emph{blue phase or later}) pay full dividends or withhold dividends
(see \subsecref{Pay-or-withhold} \nameref{subsec:Pay-or-withhold}).
\end{itemize}
...
tile upgrade if all public company station markers on the track tile
can be placed in city circles on the upgraded track tile.
\begin{description}
...
phase (see \parref{Train-purchasing} \nameref{par:Train-purchasing}
...
\item The \noun{Crédit Mobilier} blue private company converts to \textflorin 740
